...
const getInfoForSetting = (guildID, settingName) => {
    ...
    switch (settingName) {
        ...
        case 'allowsbzscammers':
            ...
            finalSettings.desc = `Allows known SkyblockZ scammers to verify.`;
        ...
        case 'guildname':
            ...
            finalSettings.desc =
                ...
                `This also enables SkyCyc's guild features (coming soon).`;
    ...
    async execute(message, args, client, prefix) {
        ...
        if (args.length == 0) {
            const settingValues = [
                ...
                ``,
                `<:role:876319690274799659> __**Role Configuration**__`,
            ...
            return message.channel.send(
                new Discord.MessageEmbed()
                    .setColor(e.default)
                    .setDescription(
                        `<:settings:876319222035251221> __**Current Settings**__\n` +
                        settingValues.join('\n')
                    )
            ).catch();
