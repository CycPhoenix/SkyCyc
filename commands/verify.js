...
const getUser = require('../lib/getStats').getUser;
...
module.exports = {
    ...
    async execute(message, args, client, prefix) {
            ...
            return channel.send(
                new Discord.MessageEmbed()
                    ...
                    .setDescription(
                        ...
                        `**Video Guide:** [youtu.be/bzi_EepVELg](https://youtu.be/bzi_EepVELg)`
                    )
                    .setColor(e.default)
        ...
        if (verificationRole == undefined) {
            const SkyCycRole = guild.roles.cache.find(r => r.name == 'Hypixel Verified');
            if (SkyCycRole !== undefined) {
                db.set(`${guildID}.roles.verified`, SkyCycRole.id);
                verificationRole = SkyCycRole;
            } else {
                let errorMessage =
